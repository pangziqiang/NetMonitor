...
private final class IOReportNetworkMonitor {
...
public class NetworkMonitorEngine: ObservableObject {
    ...
    private var ioReportMonitor: IOReportNetworkMonitor?
